...
namespace McgInterop
{
					...
					ref global::Interop_mincore_COPYFILE2_EXTENDED_PARAMETERS__System_IO_FileSystem pExtendedParameters)
		{
			...
			fixed (char* pinned_pwszExistingFileName = pwszExistingFileName)
			{
				...
				fixed (char* pinned_pwszNewFileName = pwszNewFileName)
				{
					...
					// Call to native method
					unsafe___value = global::McgInterop.api_ms_win_core_file_l2_1_0_dll_PInvokes.CopyFile2(
	...
	public unsafe static partial class api_ms_win_core_file_l1_1_0_dll
	{
					...
					ref global::Interop_mincore_SECURITY_ATTRIBUTES__System_IO_FileSystem lpSecurityAttributes)
		{
			...
			fixed (char* pinned_path = path)
			{
				...
				// Call to native method
				unsafe___value = global::McgInterop.api_ms_win_core_file_l1_1_0_dll_PInvokes.CreateDirectoryPrivate(
									unsafe_path, 
		...
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("System.IO.FileSystem, Version=4.0.1.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "Interop+mincore", "SetFileAttributesPrivate")]
					...
					int attr)
		{
			...
			fixed (char* pinned_name = name)
			{
				unsafe_name = (ushort*)pinned_name;
				// Call to native method
				unsafe___value = global::McgInterop.api_ms_win_core_file_l1_1_0_dll_PInvokes.SetFileAttributesPrivate(
									unsafe_name, 
									attr
								);
				global::System.Runtime.InteropServices.DebugAnnotations.PreviousCallContainsUserCode();
	...
	public unsafe static partial class api_ms_win_core_file_l1_1_0_dll_PInvokes
	{
		...
		[global::McgInterop.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("api-ms-win-core-file-l1-2-1.dll", EntryPoint="SetFileAttributesW", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
