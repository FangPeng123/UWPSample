...
namespace EscalationSystem.Views
{
    ...
    /// Author: yong
    /// </summary>
    public sealed partial class ShowNotificationForm : UserControl
    {
        private string content;
        private TimeSpan showTime;
        private Popup popup;

        public ShowNotificationForm()
        {
        ...
        public ShowNotificationForm(string content, TimeSpan showTime):this()
        {
            this.content = content;
            this.showTime = showTime;
        }

        public ShowNotificationForm(string content):this(content,TimeSpan.FromSeconds(1))
        {
        }
