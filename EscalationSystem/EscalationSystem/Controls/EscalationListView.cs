...
namespace EscalationSystem.Controls
{
   public class EscalationListView:ListView
    {
        public static readonly DependencyProperty OddRowBackgroundProperty =
       DependencyProperty.Register("OddRowBackground", typeof(Brush), typeof(EscalationListView), null);
        ...
        public static readonly DependencyProperty EvenRowBackgroundProperty =
            DependencyProperty.Register("EvenRowBackground", typeof(Brush), typeof(EscalationListView), null);
